...
function Lunar(objDate) {
 ...
 function YYMMDD(){ 
    var cl = '<font STYLE=" color:#FFFFFF; font-size:12px;">'; 
    if (now.getDay() == 0) cl = '<font color="#ffffff" STYLE="font-size:9pt;">'; 
    if (now.getDay() == 6) cl = '<font color="#ffffff" STYLE="font-size:9pt;">';
...
function cDay(m,d){
 ...
 function solarDay2(){
    var sDObj = new Date(SY,SM,SD);
    var lDObj = new Lunar(sDObj);
    var cl = '<font color="#ffffff" STYLE="font-size:9pt;">'; 
...
"1006 老人节","1001 ListenWind生日","1024 联合国日","1112 孙中山诞辰","1220 澳门回归纪念","1225 圣诞节","1226 毛泽东诞辰")
  ...
  if(solarTerms == '' && solarFestival == '' && lunarFestival == '')
    ...
    '<FONT COLOR="#ffffff" STYLE="font-size:9pt;">'+solarTerms + ' ' + solarFestival + ' ' + lunarFestival+'</FONT></TD>'+
    '</TR></TABLE>';
 ...
 function setCalendar(){
    document.write('<table CELLPADDING=0 CELLSPACING=0 border=0><tr><td><table border=0 CELLPADDING=0 CELLSPACING=0><tr><td align=center class=f2>');
