...
//	service.addTask(new JobInf(null, "��������", "group", 1, "*", "com.jt.gateway.service.job.QuartzTest", "����", "trigger", "triggerGroup", new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis())));
	return "hello";
}
